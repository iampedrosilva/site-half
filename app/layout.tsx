  ...
  return (
    <html lang="pt-BR" className="scroll-smooth">
      <head>
        ...
        <meta name="keywords" content="gestão de frota, manutenção de veículos, benefícios corporativos, tecnologia, segurança, soluções inovadoras, empresas, órgãos públicos, Half Benefícios" />
