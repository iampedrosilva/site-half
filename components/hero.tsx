...
export default function Hero() {
  ...
  const metrics = [
    { value: "R$ 34,2 milhões", label: "Transacionados", icon: HandCoins, color: "text-emerald-400 drop-shadow-lg" },
  ...
  return (
    <section className="relative overflow-hidden min-h-[90vh] flex items-center">
      {/* Overlay gradiente semi-transparente — deixa os blobs do fundo infinito aparecerem */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50/85 via-white/75 to-cyan-50/85" />

      {/* Orb decorativo pulsante no hero */}
      <motion.div
        className="absolute top-10 right-[8%] w-72 h-72 rounded-full pointer-events-none"
        style={{
          background: "radial-gradient(circle, rgba(2,95,199,0.22) 0%, transparent 70%)",
        }}
      ...
      <motion.div
        ...
        style={{
          background: "radial-gradient(circle, rgba(13,151,235,0.18) 0%, transparent 70%)",
        }}
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 lg:py-28 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <motion.a
                ...
                className="relative inline-flex items-center gap-3
                  px-12 py-4 min-w-[300px] justify-center rounded-xl
                  bg-gradient-to-r from-[#025fc7] to-[#0d97eb]
                  text-white text-sm font-semibold
                  shadow-lg hover:shadow-[0_8px_30px_rgba(2,95,199,0.45)]
          ...
          >
            {/* Orb atrás do card */}
            <div className="absolute -top-12 -right-12 w-96 h-96 bg-[#025fc7] rounded-full blur-3xl opacity-15 animate-blob" />
            <div className="absolute -bottom-8 -left-8 w-64 h-64 bg-[#0d97eb] rounded-full blur-3xl opacity-10 animate-blob animation-delay-4000" />

            {/* Card principal com borda gradiente no hover */}
            <div className="gradient-border relative w-80 lg:w-96">
              <div className="bg-gradient-to-b from-[#025fc7] to-[#0d97eb] rounded-3xl shadow-2xl overflow-hidden">
                ...
                <p className="text-sm text-white/80 px-6 mb-6">Impacto total no Brasil</p>
                ...
                <div className="grid grid-cols-2 gap-3 px-6">
                  {metrics.map((m, i) => (
                    ...
                    >
                      <m.icon className={`w-10 h-10 ${m.color} mb-2`} />
                      <p className="text-xl font-black text-white leading-none text-center">{m.value}</p>
