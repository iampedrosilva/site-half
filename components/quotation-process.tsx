  ...
  return (
    <section className="py-16 bg-[#f8fafc]">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12 text-[#025fc7]">Processo de Orçamentos Eletrônicos</h2>
        <div className="flex justify-center items-center space-x-8 relative">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="flex flex-col items-center text-center relative bg-white p-6 rounded-lg shadow-md z-10"
            >
              ...
              {index < steps.length - 1 && (
                <div className="absolute top-1/2 left-full w-8 transform -translate-y-1/2">
                  <Arrow />
                </div>
              )}
            </motion.div>
